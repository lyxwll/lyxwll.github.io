...
![img](/img/2016-4-25/018.png)    

###讲解14      
![img](/img/2016-4-25/019.png)    
...
当你看到这个界面，就表示导入成功了。项目使用 **Ant** 构建，并不是**Android Studio** 默认的 **Gradle** 。   
